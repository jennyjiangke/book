...
stats_report <- bind_rows(stats_report, sd_report)
rownames(stats_report) <- c("mean","median","mode","min","max","IQR", "sd")
stats_report <- stats_report[,-12]
```
...
The high standard deviations of all nine variables indicate high variations between values and abnormal distributions for data.
