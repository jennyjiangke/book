...
knitr::kable(head(my_data, 20), digits = 5, booktabs = TRUE,
  caption = 'The First 20 Rows of the Google Analytics Sample Data', format = 'markdown') %>%
