...
knitr::kable(head(data, 20), digits = 0, booktabs = TRUE,
  caption = 'Author Information of Twitter Discourses Using the Co-hashtags of #BlackLivesMatter and #StopAsianHate'
) %>%
